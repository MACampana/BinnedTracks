...
for y in ${years[@]}; do
    for d in ${dates[@]}; do
        ...
        filelist1=(/data/exp/IceCube/$y/filtered/level2/$d/Run*_*/Level2_IC86*.i3.zst)
        filelist2=()
        ...
        echo "python /data/user/mcampana/analysis/binned_tracks/level2.py --input ${filelist2[@]} --output /data/user/mcampana/analysis/binned_tracks/data/level2/exp/Level2_${d}${y}_exp.npy --fix-leap " >> ${exec_path}
