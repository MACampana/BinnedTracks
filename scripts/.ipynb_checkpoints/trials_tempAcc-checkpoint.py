...
from modules.binnedtemplate import LiMaStats_tempAcc as LiMaStats
...
p.add_argument('--save-trials', type=str, required=True, 
               help='Path to save trials dictionary.')
...
lima_bean = LiMaStats(args.data_path, args.sig_path, args.grl_path, is_binned=args.is_binned, savedir=args.savedir, name=args.name, 
                     ...
                     nside=args.nside, num_bands=args.num_bands, min_dec_deg=args.min_dec_deg, max_dec_deg=args.max_dec_deg, verbose=args.verbose)
...
save_file = f"{args.save_trials}/trials{args.num_trials}_nsig{args.nsig}_seed{args.seed}_tempAcc_cutoff{args.cutoff}.npy"
