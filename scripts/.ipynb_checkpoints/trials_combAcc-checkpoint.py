...
from modules.binnedtemplate import LiMaStats_combAcc as LiMaStats
...
save_file = f"{args.save_trials}/trials{args.num_trials}_nsig{args.nsig}_seed{args.seed}_combAcc_cutoff{args.cutoff}.npy"
