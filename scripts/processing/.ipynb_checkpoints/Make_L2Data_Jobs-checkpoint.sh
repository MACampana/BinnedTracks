...
for y in ${years[@]}; do
    for d in ${dates[@]}; do
        ...
        echo "python /data/user/mcampana/analysis/binned_tracks/scripts/processing/level2.py --input ${filelist2[@]} --output /data/user/mcampana/analysis/binned_tracks/data/level2/exp/Level2_${d}${y}_exp.npy --fix-leap " >> ${exec_path}
